...
CONTEXT_CANDIDATES=(${CONTEXT_CANDIDATES:-262144 210672 196608 131072 98304 65536})
GPU_UTIL_CANDIDATES=(${GPU_UTIL_CANDIDATES:-0.92 0.90 0.88})

# Phase 2: benchmark configs under the chosen context.
SEQ_CANDIDATES=(${SEQ_CANDIDATES:-4 2 1})
BATCH_CANDIDATES=(${BATCH_CANDIDATES:-4096})
